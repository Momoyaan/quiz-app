...
const Stats = () => {
  ...
  useEffect(() => {
    axios
      .get("http://15.235.140.8:5000/quiz/completions/count")
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    axios
      .get("http://15.235.140.8:5000/quizzes/active")
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    axios
      .get(`http://15.235.140.8:5000/users/${userId}`)
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    axios
      .get(`http://15.235.140.8:5000/questions/count`)
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    axios
      .get(`http://15.235.140.8:5000/quiz/view/count/${userId}`)
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    axios
      .get(`http://15.235.140.8:5000/quiz/passingrate/${userId}`)
      .then((response) => {
        if (response.data) {
